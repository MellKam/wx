...
describe("Lexer", () => {
	...
	it("should tokenize float literals", () => {
		assertEquals(lexer.tokenize("1.0 + 2.05"), [
			...
			<Token>{ kind: TokenKind.FloatLiteral, value: "2.05", start: 6, end: 10 },
		]);
	});
	...
	it("should tokenize identifiers", () => {
		...
		assertEquals(lexer.tokenize("abc_123"), [
			<Token>{ kind: TokenKind.Identifier, value: "abc_123", start: 0, end: 7 },
		]);
	...
	it("should tokenize comparison operators", () => {
		...
		assertEquals(lexer.tokenize("<="), [
			<Token>{ kind: TokenKind.LessThanOrEqual, value: "<=", start: 0, end: 2 },
		]);
		assertEquals(lexer.tokenize(">"), [
