import { ExpressionKind, Parser, StatementKind } from "./parser/parser.ts";
import type {
...
describe("Parser", () => {
	...
	it("should parse simple expression", () => {
		...
		assertEquals(parser.parse_expression(tokens), <BinaryExpression>{
	...
	it("should handle unary minus", () => {
		...
		assertEquals(parser.parse_expression(tokens), <UnaryExpression>{
	...
	it("should handle identifier expression", () => {
		...
		assertEquals(parser.parse_expression(tokens), <IdentifierExpression>{
